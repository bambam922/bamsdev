...
namespace Styx.Bot.Plugins.AutoEquip2
{
    public class AutoEquipSettings : Settings
    {
        ...
        public AutoEquipSettings()
            : base(Path.Combine(Utilities.AssemblyDirectory, string.Format("Settings\\{0}\\{1}\\AutoEquipSettings.xml", StyxWoW.Me.RealmName, StyxWoW.Me.Name)), 
                   Path.Combine(Utilities.AssemblyDirectory, string.Format("Settings\\AutoEquipSettings_{0}.xml", StyxWoW.Me.Name)))
        {
        ...
        [DefaultValue(true)]
        [Category("Disenchanting")]
        [DisplayName("Disenchant BoP Blues?")]
        ...
        [DefaultValue(false)]
        [Category("Disenchanting")]
        [DisplayName("Disenchant BoE Blues?")]
        ...
        [DefaultValue(true)]
        [Category("Disenchanting")]
        [DisplayName("Disenchant BoP Purples?")]
        ...
        [DefaultValue(false)]
        [Category("Disenchanting")]
        [DisplayName("Disenchant BoE Purples?")]
